...
export default function Projects() {
  ...
  const Projects_Array = [
    ...
    {
      id: 2,
      project_name: "Beetalk – MERN Chat Application",
      description: `Beetalk is a comprehensive full-stack web application designed to facilitate real-time communication between users. 
      It allows users to create accounts, join chat rooms, and engage in one-on-one conversations.
      The application features a user-friendly interface, message notifications, and the ability to upload profile pictures.`,
      image: [
        "./img/login-signup.jpg",
        "./img/homepageChat.jpg",
        "./img/setting.jpg",
      ...
      github_repo: "https://github.com/khoiphan-9194/MERN-Chat-App-KP",
    },
